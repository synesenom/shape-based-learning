...
|---|---|---|---|
| 1 | Clean, flat 2D drawings (10 classes) | Does the shape-graph representation work at all? | experiments running |
| 2 | The same drawings under rotation, shear and perspective | Is a bike at an angle still two ellipses and a triangle? | code in progress |
| 3 | Textures, QuickDraw sketches, real photos | Does it survive realistic appearance? | code in progress |
...
dataset version 1, before the twin fix. It is superseded by the runs in
progress.
