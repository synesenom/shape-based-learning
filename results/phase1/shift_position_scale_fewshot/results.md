...
|---|---|---|---|---|---|---|
| CNN | 0.988 ± 0.010 | 0.221 ± 0.030 | 0.768 ± 0.020 | 0.991 ± 0.007 | - | 11,173,962 |
| CNN + aug | 0.998 ± 0.001 | 0.827 ± 0.066 | 0.172 ± 0.065 | 1.000 ± 0.000 | - | 11,173,962 |
...
| CNN + strong aug | 0.999 ± 0.001 | 0.959 ± 0.132 | 0.040 ± 0.131 | 1.000 ± 0.000 | - | 11,173,962 |
